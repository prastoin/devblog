...
Inside the parallel machine would be found two parallel states waiting for their specific resources, here `1` and `2`, to be fulfilled by the user before reaching their final states.
