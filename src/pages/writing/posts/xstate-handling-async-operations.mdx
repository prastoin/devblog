...
name: prastoin
description: Thanks to XState promises invocation and parallel states, we're able to configure a machine that centralize all the logic outside the view, in an human readable and exportable way.
---
                                ...
                                'Fetching user information from server': {
                                    ...
                                    invoke: {
                                        ...
                                        onDone: {
                                            ...
                                            actions:
                                                'Assign loaded user information to context',
                                        },
                                ...
                                'Fetching user cart from server': {
                                    ...
                                    invoke: {
                                        ...
                                        onDone: {
                                            ...
                                            actions:
                                                'Assign loaded user cart to context',
                                        },
        ...
        <div class="flex flex-col">
            ...
            <template v-else>
                ...
                <div class="flex flex-col justify-center items-start m-auto">
                    ...
                    <template
                        v-if="
                            userInformationStatus === 'failed' ||
                            userCartStatus === 'failed'
                        "
                    >
                        <BaseButton
                ...
                <template
                    v-if="
                        userInformationStatus === 'success' &&
                        userCartStatus === 'success'
                    "
                >
