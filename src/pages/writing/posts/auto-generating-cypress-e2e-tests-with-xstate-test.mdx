...
- [What and how we're testing](#what-and-how-we-re-testing)
- [@xstate/test quick overview](#xstate-test-quick-overview)
...
Depending on your test architecture this could bring a lot a complexity in the refactor, as it could spread to be refactoring every wizard form related tests.
...
## <BaseAnchor label="@xstate/test face to our app" />
...
### <BaseAnchor lable="Autogenerating the tests"/>
...
### Not returning promises in paths generations
...
### Using async operations aside Cypress assertions
...
`xstate/test` is still under development and might soon release it's [v1.0](https://github.com/statelyai/xstate/releases/tag/%40xstate%2Ftest%401.0.0-alpha.0) !

## <BaseAnchor label="Working and test example" />
