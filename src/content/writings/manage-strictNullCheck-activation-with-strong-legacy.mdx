---
title: My approach to handle massive amounts of `TypeScript` legacy
publishDate: 20 jan 2024
description: When onboarding on a new `TypeScript` project you might encounter strong legacy due to too permissive configuration or not idiomatic implementation, in this article we see my approach to reduce them.
---
...
Something anyone, when having to handle `TypeScript` legacy has been thinking abouth, is to attribute scoped rules to a specific folder.
